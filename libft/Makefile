...
#    Updated: 2018/06/07 18:59:49 by bpierce          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
FILES = bzero memalloc memccpy memchr memcmp memcpy memdel memmove memset \
		...
		strdel strdeltwo strdelthree strdelfour strdup strndup strdupuntil \
		strdupfrom \
